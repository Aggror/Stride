...
{
    /// <summary>
    /// Indicates that a class or structure can be serialized.
    /// </summary>
    ...
    public class DataContractAttribute : Attribute
    {
        ...
        /// <summary>
        /// The alias name when serializing to a textual format.
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether this <see cref="DataContractAttribute"/> is implicitly inherited by all its descendant classes.
        /// </summary>
